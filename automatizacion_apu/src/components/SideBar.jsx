  ...
  return (
    <main>
      <div className=" text-sm  w-60 mt-4 mb-4 p-2 rounded-lg ml-2 shadow-xl">
        ...
        <Link
          to={"/"}
          className=" gap-2 mt-6 mr-3 ml-2 flex text-white p-2 rounded-lg bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500"
        >
          <svg
        ...
        <Link
          to={"/familias"}
          className="  gap-2 mt-3 mr-3 ml-2 flex text-white p-2 rounded-lg bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
